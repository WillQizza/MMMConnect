...
<html>
    <head>
        ...
        <link href="assets/css/feed.css" rel="stylesheet" type="text/css" />
        ...
        <nav class="navbar is-info">
            ...
            <div class="navbar-menu">
                <div class="navbar-end">
                    ...
                    <a class="navbar-item" href="/"><i class="fas fa-bell"></i></a>
                    
                    <a class="navbar-item" href="/"><i class="fas fa-envelope"></i></a>

                    <a class="navbar-item" href="/"><i class="fas fa-user-friends"></i></a>
                    
                    <a class="navbar-item" href="/"><i class="fas fa-cogs"></i></a>

                    <a class="navbar-item" href="logout"><i class="fas fa-sign-out-alt"></i></a>
                </div>
            </div>
        </nav>
        <div id="content">
